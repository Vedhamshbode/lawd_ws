...
from lawd_msgs.msg import Geometry
...
class InvKin_Node(Node):
    def __init__(self):
        ...
        self.sub_ = self.create_subscription(Geometry, 'lawd_geometry', self.sub_callback, 30)
        self.pub2STM = self.create_publisher(Float32MultiArray, 'lawd_jointController/commands', 30)
        timer_period = 0.02
