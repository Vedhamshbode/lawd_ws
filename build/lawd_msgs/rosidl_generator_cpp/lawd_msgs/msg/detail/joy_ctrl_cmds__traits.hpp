...
#ifndef LAWD_MSGS__MSG__DETAIL__JOY_CTRL_CMDS__TRAITS_HPP_
#define LAWD_MSGS__MSG__DETAIL__JOY_CTRL_CMDS__TRAITS_HPP_
...
inline void to_yaml(
  const lawd_msgs::msg::JoyCtrlCmds & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const lawd_msgs::msg::JoyCtrlCmds & msg)
{
  return lawd_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<lawd_msgs::msg::JoyCtrlCmds>()
{
  return "lawd_msgs::msg::JoyCtrlCmds";
}

template<>
inline const char * name<lawd_msgs::msg::JoyCtrlCmds>()
{
  return "lawd_msgs/msg/JoyCtrlCmds";
}

template<>
struct has_fixed_size<lawd_msgs::msg::JoyCtrlCmds>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Pose>::value && has_fixed_size<geometry_msgs::msg::Vector3>::value> {};

template<>
struct has_bounded_size<lawd_msgs::msg::JoyCtrlCmds>
...
template<>
struct is_message<lawd_msgs::msg::JoyCtrlCmds>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // LAWD_MSGS__MSG__DETAIL__JOY_CTRL_CMDS__TRAITS_HPP_
