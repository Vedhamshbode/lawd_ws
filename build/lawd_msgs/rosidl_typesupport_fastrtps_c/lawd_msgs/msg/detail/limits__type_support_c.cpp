...
#include "lawd_msgs/msg/detail/limits__rosidl_typesupport_fastrtps_c.h"
...
using _Limits__ros_msg_type = lawd_msgs__msg__Limits;
...
size_t get_serialized_size_lawd_msgs__msg__Limits(
  const void * untyped_ros_message,
...
static uint32_t _Limits__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lawd_msgs__msg__Limits(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lawd_msgs
size_t max_serialized_size_lawd_msgs__msg__Limits(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lawd_msgs__msg__Limits;
    is_plain =
      (
...
static size_t _Limits__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lawd_msgs__msg__Limits(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lawd_msgs, msg, Limits)() {
