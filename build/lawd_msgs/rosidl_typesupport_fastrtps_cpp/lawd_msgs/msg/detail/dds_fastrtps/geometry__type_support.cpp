...
#include "lawd_msgs/msg/detail/geometry__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lawd_msgs::msg::Geometry;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lawd_msgs::msg::Geometry *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lawd_msgs::msg::Geometry *>(
    untyped_ros_message);
...
{
  return &lawd_msgs::msg::typesupport_fastrtps_cpp::_Geometry__handle;
}
