...
#include "lawd_msgs/msg/detail/limits__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lawd_msgs::msg::Limits & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lawd_msgs::msg::Limits & ros_message)
{
  // Member: eular_ang_range
  {
    cdr >> ros_message.eular_ang_range;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lawd_msgs::msg::Limits;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lawd_msgs::msg::Limits *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lawd_msgs::msg::Limits *>(
    untyped_ros_message);
...
{
  return &lawd_msgs::msg::typesupport_fastrtps_cpp::_Limits__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lawd_msgs, msg, Limits)() {
  return &lawd_msgs::msg::typesupport_fastrtps_cpp::_Limits__handle;
}
