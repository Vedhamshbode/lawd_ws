...
#include "lawd_msgs/msg/detail/joy_ctrl_cmds__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lawd_msgs::msg::JoyCtrlCmds & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lawd_msgs::msg::JoyCtrlCmds & ros_message)
{
  // Member: states
  {
    cdr >> ros_message.states;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lawd_msgs::msg::JoyCtrlCmds;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lawd_msgs::msg::JoyCtrlCmds *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lawd_msgs::msg::JoyCtrlCmds *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_lawd_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<lawd_msgs::msg::JoyCtrlCmds>()
{
  return &lawd_msgs::msg::typesupport_fastrtps_cpp::_JoyCtrlCmds__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lawd_msgs, msg, JoyCtrlCmds)() {
  return &lawd_msgs::msg::typesupport_fastrtps_cpp::_JoyCtrlCmds__handle;
}
