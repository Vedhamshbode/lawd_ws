...
#ifndef LAWD_MSGS__MSG__DETAIL__LIMITS__STRUCT_HPP_
#define LAWD_MSGS__MSG__DETAIL__LIMITS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__lawd_msgs__msg__Limits __attribute__((deprecated))
#else
# define DEPRECATED__lawd_msgs__msg__Limits __declspec(deprecated)
#endif
...
struct Limits_
{
  ...
  // pointer types
  using RawPtr =
    lawd_msgs::msg::Limits_<ContainerAllocator> *;
  using ConstRawPtr =
    const lawd_msgs::msg::Limits_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<lawd_msgs::msg::Limits_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<lawd_msgs::msg::Limits_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      lawd_msgs::msg::Limits_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<lawd_msgs::msg::Limits_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<lawd_msgs::msg::Limits_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<lawd_msgs::msg::Limits_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<lawd_msgs::msg::Limits_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__lawd_msgs__msg__Limits
    std::shared_ptr<lawd_msgs::msg::Limits_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__lawd_msgs__msg__Limits
    std::shared_ptr<lawd_msgs::msg::Limits_<ContainerAllocator> const>
...
using Limits =
  lawd_msgs::msg::Limits_<std::allocator<void>>;
...
#endif  // LAWD_MSGS__MSG__DETAIL__LIMITS__STRUCT_HPP_
